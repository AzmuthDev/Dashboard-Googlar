                        ...
                        {navigationItems.map((item) => {
                            ...
                            return (
                                <li key={item.id} className="relative">
                                    ...
                                    {isDarkMode ? (
                                        <GlowingEffect spread={40} glow={false} disabled={!isActive} proximity={64} inactiveZone={0.01} borderWidth={1} variant="default" />
                                    ) : (
                                        <GlowingEffect spread={30} glow={false} disabled={isActive} proximity={48} inactiveZone={0.01} borderWidth={1} variant="default" />
                                    )}
                                    <button
                                        ...
                                        className={[
                                            ...
                                            isActive
                                                ? (isDarkMode 
                                                    ? 'bg-zinc-800/80 text-white font-bold border border-white/10 shadow-lg scale-[1.01] hover:bg-zinc-700/90 hover:translate-x-0.5 hover:pl-4' 
                                                    : 'bg-primary text-primary-foreground font-bold shadow-[0_0_20px_rgba(0,0,0,0.05)] scale-[1.02] border-none hover:bg-zinc-800 hover:translate-x-0.5 hover:pl-4')
                                                : (isLocked || isBrief)
